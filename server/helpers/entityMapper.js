...
const relationshipJsonToObj = exports.relationshipJsonToObj = (relationshipJson) => {
  if (typeof relationshipJson !== "undefined") {
    return {
      ...
      userIdWhoShareData: relationshipJson.user_id_who_share_data,
      userIdWhoReceiveData: relationshipJson.user_id_who_receive_data
    };
  }
};
...
const relationshipObjToJson = exports.relationshipObjToJson = (relationshipObj) => {
  if (typeof relationshipObj !== "undefined") {
    return {
      ...
      user_id_who_share_data: relationshipObj.userIdWhoShareData,
      user_id_who_receive_data: relationshipObj.userIdWhoReceiveData
    };
  }
};
